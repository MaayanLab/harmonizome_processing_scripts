...
gene_atb.edges.targetdesc(strcmp(gene_atb.edges.target, 'Epstein-Barr virus infectious disease')) = {'DOID:0050204'};
gene_atb.edges.targetdesc(strcmp(gene_atb.edges.target, 'Helicobacter pylori gastritis')) = {'DOID:4033'};
gene_atb.edges.targetdesc(strcmp(gene_atb.edges.target, 'Helicobacter pylori infectious disease')) = {'DOID:104'};
gene_atb.edges.targetdesc(strcmp(gene_atb.edges.target, 'coagulation factor deficiency')) = {'DOID:1247'};
gene_atb.edges.targetdesc(strcmp(gene_atb.edges.target, 'copper metabolism disease')) = {'DOID:896'};
gene_atb.edges.targetdesc(strcmp(gene_atb.edges.target, 'corneal anesthesia and hypoesthesia')) = {'DOID:10124'};
gene_atb.edges.targetdesc(strcmp(gene_atb.edges.target, 'diabetic nephropathy')) = {'DOID:557'};
gene_atb.edges.targetdesc(strcmp(gene_atb.edges.target, 'disorder of magnesium metabolism')) = {'DOID:896'};
gene_atb.edges.targetdesc(strcmp(gene_atb.edges.target, 'drug induced sleep disorder')) = {'DOID:535'};
gene_atb.edges.targetdesc(strcmp(gene_atb.edges.target, 'localized malignant mesothelioma')) = {'DOID:1790'};
gene_atb.edges.targetdesc(strcmp(gene_atb.edges.target, 'magnesium deficiency')) = {'DOID:896'};
gene_atb.edges.targetdesc(strcmp(gene_atb.edges.target, 'mesothelioma malignant recurrent')) = {'DOID:1790'};
gene_atb.edges.targetdesc(strcmp(gene_atb.edges.target, 'neurological disorder')) = {'DOID:331'};
gene_atb.edges.targetdesc(strcmp(gene_atb.edges.target, 'non small cell lung cancer recurrent')) = {'DOID:3908'};
gene_atb.edges.targetdesc(strcmp(gene_atb.edges.target, 'retinal detachment and defect')) = {'DOID:5327'};
