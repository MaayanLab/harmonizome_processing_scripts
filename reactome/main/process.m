...
atb_gene.lists = listsinit(1816, [], 'Pathway', [], 'Reactome ID', [], [], [], 'GeneSym', [], [], [], [], false, []);
...
for i = 1:1:atb_gene.lists.numterms
    ...
    atb_gene.lists.term{i} = strtrim(currcells{1});
    atb_gene.lists.termdesc{i} = strtrim(currcells{2});
    atb_gene.lists.entries{i} = cellfun(@strtrim, currcells(4:end)', 'uniformoutput', false);
