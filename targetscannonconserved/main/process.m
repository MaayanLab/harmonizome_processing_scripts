...
gene_atb.edges = edgesinit(8592712, [], 'GeneSym', [], [], [], 'GeneID', [], 'microRNA Symbol', [], [], [], [], true, []);


% read data
fid = fopen('input/Nonconserved_Site_Context_Scores_Human.txt', 'r');
...
% save('input/gene_mirna_targetscan_nonconserved_unprocessed_20150727.mat', '-struct', 'gene_atb'); % too large
%}

% load data
% gene_atb = load('input/gene_mirna_targetscan_nonconserved_unprocessed_20150727.mat', '-mat', 'edges');
