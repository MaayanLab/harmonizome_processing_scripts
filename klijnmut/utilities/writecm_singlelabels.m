function writecm_singlelabels(filename, cm)
...
writematrix_singlelabels(filename, cm.matrix, collabelname1, collabel1, collabelname2, collabel2, collabelname3, collabel3, rowlabelname1, rowlabel1, rowlabelname2, rowlabel2, rowlabelname3, rowlabel3);
