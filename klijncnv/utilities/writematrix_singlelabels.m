function writematrix_singlelabels(filename, matrix, collabelname1, collabel1, collabelname2, collabel2, collabelname3, collabel3, rowlabelname1, rowlabel1, rowlabelname2, rowlabel2, rowlabelname3, rowlabel3)
...
fprintf(fid, '%s\r\n', strjoin([{[rowlabelname1 '\' collabelname1]} collabel1'], '\t'));

fmt = strjoin([{'%s\t'} repmat({'%f\t'}, 1, Nc-1) {'%f\r\n'}], '');

for i = 1:1:Nr
    
    fprintf(fid, fmt, rowlabel1{i}, matrix(i,:));
