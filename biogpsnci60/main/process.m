...
gene_atb.cm = cminit(22283, 108, [], 'GeneSym', [], 'ProbeID', [], 'GeneID', [], 'Cell Line', [], [], [], [], []);
...
% read data
fid = fopen('input/NCI60_U133A_20070815.raw.csv', 'r');
currline = fgetl(fid);
currcells = strsplit(currline, ',', 'CollapseDelimiters', false);
...
fclose(fid);
gene_atb.cm.matrix = dlmread('input/NCI60_U133A_20070815.raw.csv', ',', 1, 1);
